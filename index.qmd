...
<img src="man/figures/logo.png" align="right" height="140" alt="bayprior logo"/>

<p>
<a href="https://CRAN.R-project.org/package=bayprior">
  <img src="https://www.r-pkg.org/badges/version/bayprior?color=green" alt="CRAN status"/>
</a>
<a href="https://github.com/ndohpenngit/bayprior/actions/workflows/R-CMD-check.yaml">
  <img src="https://github.com/ndohpenngit/bayprior/actions/workflows/R-CMD-check.yaml/badge.svg" alt="R CMD check"/>
</a>
<a href="https://app.codecov.io/gh/ndohpenngit/bayprior">
  <img src="https://codecov.io/gh/ndohpenngit/bayprior/branch/main/graph/badge.svg" alt="codecov"/>
</a>
<a href="https://ndohpenn-bayprior.share.connect.posit.cloud">
  <img src="https://img.shields.io/badge/Shiny-Live_App-blue?logo=r" alt="Live app"/>
</a>
</p>
...
This complements the existing R ecosystem for Bayesian trial design and
historical-data borrowing by bringing structured elicitation, prior-data
conflict diagnostics, and regulatory report generation together in one
integrated workflow. The FDA's 2026 draft guidance on Bayesian methods
makes this a growing area of focus.
